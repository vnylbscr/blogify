         ...
         <Grid container justifyContent='center' alignItems='center'>
            <Card className={classes.card}>
                  ...
                  action={
                     <Fragment>
                        ...
                        <Menu open={Boolean(anchorEl)} anchorEl={anchorEl} onClose={() => setAnchorEl(null)}>
                           <MenuItem onClick={handleClickInformation}>Daha fazla bilgi al</MenuItem>
                           <MenuItem onClick={handleClickContact}>İletişime geç</MenuItem>
               ...
               <Grid container xs={8} md={12} justifyContent='center'>
                  <CardMedia image={imageUrl} title='Resim' className={classes.image} />
               </Grid>
               <CardContent>
